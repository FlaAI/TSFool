...
The implementation of FGSM, BIM, DeepFool and PGD attacks is based on **Torchattacks:**
```python
...
For transfer attack, a public adversarial UCR set (generated by ResNet + BIM) is used: 
