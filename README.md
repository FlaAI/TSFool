...
- The **adversarial sets generated by TSFool** are available [here](https://github.com/FlaAI/TSFool/tree/main/datasets/adversarial).
- The **detailed experimental setup** can be found [here](#jump).
...
# <span id="jump"></span> Detailed Experimental Setup
...
hsj = HopSkipJump(classifier, targeted=False)
```
